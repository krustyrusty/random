...
class Processes():
    ...
    TODO: b=8 bursts
     #each cpu bound process will have b=8 bursts before terminating.
    #btwn bursts, each process is blocked on I/O for a random amount of time in the range 1200-3200ms.
    def cpuBoundBursts(self):
        blockTime = generateRandomNumber(1.2, 3.2)
        setState(0,0,1)
